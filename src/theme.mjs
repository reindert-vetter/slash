...
// shared between /pr/<id> (index.html + home.mjs, via a slim row in
// prInfoCard — see conventions.md, "Thema" — deliberately not inside
// Footer.mjs, which only shows once there is diff content to preview) and
